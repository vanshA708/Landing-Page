...
control[0].onclick = function(){
    image.src = "asset/images/illustration-features-tab-1.svg";
...
control[1].onclick = function(){
    image.src = "asset/images/illustration-features-tab-2.svg";
...
control[2].onclick = function(){
    image.src = "asset/images/illustration-features-tab-3.svg";
...
button.onclick = function() {
    if (menu.style.display == "none"){
        ...
        button.src = "asset/images/icon-close.svg";
        logo.style.filter = "invert(1) brightness(100%)";
        button.style.filter = "invert(0)";
    }
    else{
        menu.style.display = "none"
        button.src = "asset/images/icon-hamburger.svg";
